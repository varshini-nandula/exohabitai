    ...
    return (
      <div className="site-container flex-grow flex items-center justify-center py-10 md:py-16">
        <GlassCard
          ...
          hoverable={false}
          animate={true}
          className="w-full max-w-md border-success/20 bg-success/5 text-center p-8 flex flex-col items-center gap-6"
        >
          ...
          <div>
            ...
            <h2 className="text-xl font-bold font-mono text-text-primary tracking-tight mt-1.5">
          ...
          <div className="flex flex-col gap-3 w-full mt-2">
            <button onClick={handleReset} className="btn-primary w-full text-xs py-2.5">
              Chart Another Candidate
            </button>
            <Link to="/rankings" className="btn-secondary w-full text-xs py-2.5 border-white/5">
    ...
    <div className="site-container flex flex-col gap-10 py-10 md:py-14">
      ...
      <section className="max-w-4xl mx-auto w-full">
        ...
        <form onSubmit={handleSubmit}>
          <GlassCard glow={true} className="flex flex-col gap-6 w-full">
            <div className="border-b border-white/5 pb-4">
              <span className="font-mono text-xs font-bold text-text-primary tracking-wide uppercase">
